...
from backend.database.models import UserModelRun, UserModelSession, Choice, Protocol
from backend.models.classifiers import get_classification, get_sentence_score
from backend.utils.countries import CountryFinder
...
class ModelDecisionMaker:
    def __init__(self):
        ...
        self.data = pd.read_csv('/Users/liuyanjun/therapy_agent/backend/EmpatheticPersonas.csv', encoding='ISO-8859-1')
